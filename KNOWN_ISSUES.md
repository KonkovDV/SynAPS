...
| KI-F16 | LOW | closed (partial pack) | Brandimarte OPT==BKS (F16a); SDST public slice (F16c); M0 `machine_duration_overrides` conformance (Wave 9). Full Shen/dmorill pack deferred: **dmorill is GPL-3.0 — do not vendor**. Native skips overrides with observe-only metadata. | `tests/test_public_instances_bks.py`, `tests/test_sdst_fjs_loader.py`, `tests/test_model_field_conformance.py`, `tests/test_wave6_residuals.py`, `tests/test_wave7_residuals.py` | F16 / T-30 / Wave 5–9 |
