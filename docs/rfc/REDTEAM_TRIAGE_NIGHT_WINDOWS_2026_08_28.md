...
| --- | --- | --- |
| Night analog 0.75–0.88 | Window leftover scan kept. Exclusive 1:1 homes (largest family first, max eligible cover), same-state continuation, empty-this-night, min setup, leftover retry, single 1-swap eject. Matching session `night-window-match-2026-08-28/` 0.9924 / 0.9766 / 0.9756 leftover 38 / 117 / 122. FFD packing session `night-window-state-2026-08-28/` 0.9912 / 0.9806 / 0.9818 kept. EDD 0.8352 / 0.8258 / 0.8198 kept. Fell-before 0.7446 kept. Rolling still `wall_clock` | Hashed P2.3 freeze stays **no**. Matching is not uniformly denser than FFD. Not a three-seed Yes |
