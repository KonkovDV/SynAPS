...
| **C-R2** | P1 | `peak_wip_drums` is a schedule functional, not a Cumulative constraint | **Named 2026-08-15:** three peaks in `cable_kpis`. C5a still gated (occupancy ≪ pool). `CABLE_CR2_DRUM_METRICS_REDTEAM_2026_08_15.md` |
...
OPS-WHEEL (maturin interpreter). C5a stays gated. Three drum peaks:
`CABLE_CR2_DRUM_METRICS_REDTEAM_2026_08_15.md`. Do not put weights into COVER.
