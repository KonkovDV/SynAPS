...
1. **C7** kernel leftovers (ingest minute grain, epsilon guard, `sat_parameters`, `scalarize()`).
...
5. Do not flip the S4 notary default. OPS-WHEEL: `OPS_WHEEL_REDTEAM_2026_08_15.md`.
