...
The universal schema works — DDL plus domain examples. The solver — both heuristic and exact — passes all 27 tests, and I've closed SDST parity for exact solve, repair, and feasibility checking. The benchmark harness shows CP-SAT running 42% faster than the greedy baseline. Research documentation is published.
...
4. [EVIDENCE_BASE](EVIDENCE_BASE.md) — claim tracking
