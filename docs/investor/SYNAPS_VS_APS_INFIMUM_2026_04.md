...
| Reproducibility | No public rerunnable benchmark or test pack found | `120/120` tests and benchmark smoke path rerun locally | SynAPS | Reproducibility is stronger than polished product language |
