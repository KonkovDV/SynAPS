...
date: "2026-04-06"
tags: [synaps, partner, audit, fact-check, evidence, academic]
mode: "evidence"
---
...
For the preserved raw historical snapshot that previously occupied this path, see [../../archive/partner-2026-04-slimming/HYPERDEEP_AUDIT_REPORT_2026_04.md](../../archive/partner-2026-04-slimming/HYPERDEEP_AUDIT_REPORT_2026_04.md).
...
| Last published full-suite pass artifact | 149/149 | **149/149 in the last fully recorded full-suite pass snapshot** |
...
| Feasibility checker constraint classes | Not audited | **7 classes verified** ✅ |
...
| Area | Finding |
| --- | --- |
| **Problem class** | Current kernel = MO-FJSP-SDST-ARC; extended MO-FJSP-SDST-ML-ARC label remains a target advisory horizon. The implemented kernel is NP-hard and correctly classified under Graham notation |
...
| **Feasibility checker** | 7 constraint classes with explicit duplicate/missing violation kinds, including ARC on setup+processing windows |
...
## Updated Partner-Safe Interpretation

The current partner-safe interpretation has evolved from v2.1.0:
...
8. The feasibility checker validates **7 constraint classes** including ARC on setup windows;
...
| 2026-04-02 | Hyper-Deep Audit v1 | 63 claims across partner surfaces | 3 fabricated, 9 metadata corrections |
| 2026-04-04 | Technical Verification | pytest + benchmark smoke | historical 149/149 full-suite snapshot, 3 defects fixed |
| 2026-04-05 | Partner Pack Slimming | Documentation alignment | Mojibake, benchmark language tightened |
