...
2. SynAPS can credibly emphasize deterministic scheduling logic and explicit roadmap boundaries around any future advisory AI layer, because OR-Tools still reflects constraint-based scheduling as the canonical backbone.
...
Current external evidence supports a narrower but defensible SynAPS proposal:
