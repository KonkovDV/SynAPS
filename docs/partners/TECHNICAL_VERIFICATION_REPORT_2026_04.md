...
| Last published full-suite pass artifact | `149/149` passed |
| Artifact provenance | earlier April 2026 full-suite verification run recorded in this evidence pack |
...
This means the repository's test surface is broader than the last published full-suite pass artifact. It does **not** yet mean that a fresh `175/175` full-suite pass has been captured in this dated report.
...
6. the evidence cited in partner materials has been refreshed to distinguish the expanded suite size from the last fully recorded full-suite pass snapshot.
...
This verification surface now also records the partner-pack corrections applied after the 2026-04-04 slimming pass:

1. active English partner docs now align benchmark language to the currently verified smoke-instance result only: `tiny_3x3`, `106.67 -> 82.0` minutes, approximately `23.1%` versus `GREED`;
...
4. the active Russian route is now explicit: `HYPER_DEEP_REPORT_2026_04_RU.md` is the concise summary surface, while the preserved long-form Russian partner narrative is routed through the archive copy of `HYPER_DEEP_REPORT_2026_04_RU_v2.md`.
