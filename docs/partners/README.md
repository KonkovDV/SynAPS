---
title: "SynAPS Partner Pack"
status: "active"
version: "3.2.1"
last_updated: "2026-04-06"
date: "2026-04-06"
tags: [synaps, partner, navigation]
mode: "reference"
---

# SynAPS Partner Pack

This directory is the reduced partner document set for SynAPS.
...
1. [PARTNER_DILIGENCE_PACKET_2026_04.md](PARTNER_DILIGENCE_PACKET_2026_04.md)
...
1. [PARTNER_ONE_PAGER_2026_04.md](PARTNER_ONE_PAGER_2026_04.md)
2. [PARTNER_DECK_2026_04.md](PARTNER_DECK_2026_04.md)
...
If you need a Mositlab-specific Russian partner memo:

1. [../partners/SYNAPS_MOSITLAB_PARTNERSHIP_2026_04.md](../partners/SYNAPS_MOSITLAB_PARTNERSHIP_2026_04.md)

If you need the preserved full Russian partner narrative:

1. [../../archive/partner-2026-04-slimming/HYPER_DEEP_REPORT_2026_04_RU_v2.md](../../archive/partner-2026-04-slimming/HYPER_DEEP_REPORT_2026_04_RU_v2.md)

## Glossary

If any term, acronym, or confidence label (C1 / C2 / C3) is unclear, start here:
...
- [PARTNER_DILIGENCE_PACKET_2026_04.md](PARTNER_DILIGENCE_PACKET_2026_04.md): bounded evidence-first diligence route
...
- [PARTNER_ONE_PAGER_2026_04.md](PARTNER_ONE_PAGER_2026_04.md): shortest summary
- [PARTNER_DECK_2026_04.md](PARTNER_DECK_2026_04.md): presentation version of the story
...
- [../partners/SYNAPS_MOSITLAB_PARTNERSHIP_2026_04.md](../partners/SYNAPS_MOSITLAB_PARTNERSHIP_2026_04.md): targeted Russian partner memo for Mositlab with explicit claim boundaries and current-state evidence framing
- [MOSKABEL_ADOPTION_PROPOSAL_2026_04_RU.md](MOSKABEL_ADOPTION_PROPOSAL_2026_04_RU.md): Hyperdeep strategic memorandum (v6.0, RU) — targeted Moskabel memo covering the 13-profile solver portfolio, the LBBD-HD scaling path, and the current 175-test collection boundary
...
- [PARTNER_CASE_STUDIES_2026_04.md](PARTNER_CASE_STUDIES_2026_04.md): open-source infrastructure Partner outcomes (Red Hat, HashiCorp, Confluent, Databricks, dbt Labs)
- [PARTNER_CASE_STUDIES_2026_04_RU.md](PARTNER_CASE_STUDIES_2026_04_RU.md): Russian version of Partner case studies
- [../../archive/partner-2026-04-slimming/HYPER_DEEP_REPORT_2026_04_RU_v2.md](../../archive/partner-2026-04-slimming/HYPER_DEEP_REPORT_2026_04_RU_v2.md)

## What Changed

The partner layer used to contain many parallel narratives, presentation-specific files, and methodology-heavy side notes.
...
- one concise Russian summary stays active, while the preserved long Russian partner narrative lives in the archive route
- fewer presentation-specific files in the main path

Older and duplicate materials were moved to [../../archive/partner-2026-04-slimming/README.md](../../archive/partner-2026-04-slimming/README.md).

## Current Position

SynAPS is strongest today as an inspectable deterministic scheduling core with 13 public solver configurations, a 175-test suite currently collected in the repository, bounded repair, reproducible verification, a minimal TypeScript control-plane boundary, and documented LBBD-HD variants in the solver portfolio.
...
The active partner pack now reflects that boundary directly.