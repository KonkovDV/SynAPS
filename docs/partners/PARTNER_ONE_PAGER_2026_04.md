---
title: "SynAPS Partner One-Pager 2026-04"
status: "active"
version: "2.0.3"
last_updated: "2026-04-07"
date: "2026-04-06"
tags: [synaps, partner, one-pager, startup]
mode: "reference"
---

# SynAPS - Partner One-Pager
...
I want to be clear. This is not an "AI replaces the planner" story. The core is deterministic. Every schedule it produces is physically feasible - the math guarantees it. The current repository proves that scheduling kernel plus routing and repair paths. A bounded advisory layer can be added above it later, but it is not a shipped runtime surface today.
...
The universal schema and domain examples are working. The repository currently collects 175 tests across 26 modules around the Python solver surfaces; the newest fully recorded full-suite pass artifact preserved in the active evidence packet is still an earlier `149/149` snapshot, so a fresh `175/175` pass artifact has not yet been published. I have a benchmark harness: on the verified smoke instance, `CPSAT-10` improves makespan from `106.67` to `82.0` minutes, or about `23.1%` versus `GREED`. Broader benchmark coverage remains open. There are published research notes, benchmark methodology surfaces, and architecture docs. And the partner pack you're reading tags every claim by evidence level.
...
1. [Partner_DILIGENCE_PACKET](PARTNER_DILIGENCE_PACKET_2026_04.md) - diligence entry point
2. [Partner_QA](PARTNER_QA_2026_04.md) - Q&A for live conversations
3. [PARTNER_DECK](PARTNER_DECK_2026_04.md) - slide narrative
4. [GLOSSARY](GLOSSARY_2026_04.md) - terms and acronyms
5. [../partners/SYNAPS_MOSITLAB_PARTNERSHIP_2026_04.md](../partners/SYNAPS_MOSITLAB_PARTNERSHIP_2026_04.md) - Russian strategic-partner memo tailored to Mositlab-level diligence
