...
_PRESET_SPECS: dict[str, GenerationSpec] = {
    ...
    # ---- Hierarchical Decomposition scale presets ----
    "industrial-2k": GenerationSpec(
        n_jobs=300,
        n_machines=50,
        operations_per_job=(5, 9),
        state_count=15,
        flexibility=0.25,
        sdst_density=0.80,
        sdst_range=(10, 40),
        proc_time_range=(15, 55),
        due_date_tightness=0.30,
        aux_resource_probability=0.35,
        aux_resource_types=8,
        seed=1,
        preset_name="industrial-2k",
    ),
    "industrial-5k": GenerationSpec(
        n_jobs=700,
        n_machines=80,
        operations_per_job=(5, 10),
        state_count=20,
        flexibility=0.20,
        sdst_density=0.85,
        sdst_range=(8, 45),
        proc_time_range=(12, 60),
        due_date_tightness=0.25,
        aux_resource_probability=0.30,
        aux_resource_types=10,
        seed=1,
        preset_name="industrial-5k",
    ),
    "industrial-10k": GenerationSpec(
        n_jobs=1500,
        n_machines=100,
        operations_per_job=(5, 10),
        state_count=25,
        ...
        sdst_density=0.85,
        sdst_range=(8, 50),
        proc_time_range=(10, 65),
        due_date_tightness=0.22,
        aux_resource_probability=0.28,
        aux_resource_types=12,
        seed=1,
        preset_name="industrial-10k",
    ),
    "industrial-50k": GenerationSpec(
        n_jobs=6000,
        n_machines=200,
        operations_per_job=(6, 12),
        state_count=30,
        flexibility=0.15,
        sdst_density=0.90,
        sdst_range=(5, 55),
        proc_time_range=(8, 70),
        due_date_tightness=0.20,
        aux_resource_probability=0.25,
        aux_resource_types=15,
        seed=1,
...
def generate_problem(spec: GenerationSpec) -> ScheduleProblem:
    ...
    setup_lb = (
        ops_per_machine * mean_setup * spec.sdst_density * (1.0 - 1.0 / max(1, spec.state_count))
    )
