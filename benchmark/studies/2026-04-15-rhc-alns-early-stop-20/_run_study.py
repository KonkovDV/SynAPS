"""Control study: RHC-ALNS greedy-only profile with early-stop=20."""
...
def main() -> None:
    artifact_dir = Path("benchmark/studies/2026-04-15-rhc-alns-early-stop-20")
    ...
    print("Running RHC-ALNS early-stop=20 control...", flush=True)
    ...
    artifact = {
        "study_kind": "rhc-50k-early-stop-control",
