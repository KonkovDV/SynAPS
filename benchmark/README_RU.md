...
Последний после исправлений артефакт с защитными ограничителями лежит в [studies/2026-04-26-rhc-alns-postfix-canonical-v4/rhc_50k_study.json](studies/2026-04-26-rhc-alns-postfix-canonical-v4/rhc_50k_study.json).
...
- после исправлений артефакт с защитными ограничителями фиксирует новое рабочее правило: oversized ALNS-окна теперь пропускаются до дорогой seed generation, чтобы не сжигать весь бюджет окна;
...
- после исправлений guarded `RHC-ALNS|throughput` даёт `mean_scheduled_ratio = 0.3028`, `mean_makespan_minutes = 9675.18` и `mean_inner_fallback_ratio = 1.0`;
