...
**Цель:** Математически строгий анализ архитектурных пределов SynAPS v1 и план масштабирования до 50 000+ производственных операций (уровень APS Infimum / Москабельмет) при сохранении объяснимости решений.
...
| Масштаб | Текущий SynAPS (v1) | Целевой SynAPS (v2, ALNS+Rust) | APS Infimum (оценка) |
|---------|---------------------|--------------------------------|---------------------|
...
**Реалистичные ожидания:** SynAPS v2 не догонит APS Infimum по скорости на 50K. Нейросеть принципиально быстрее для inference. Преимущество SynAPS — объяснимость, аудируемость, нижняя граница на подзадачах.
