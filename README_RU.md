...
## Партнёрские и верификационные материалы

Опциональный пакет для проверки может жить в `docs/partners/`.
...
Если партнёрский слой всё же нужен, начинайте с [docs/partners/README_RU.md](docs/partners/README_RU.md). Этот путеводитель теперь ведёт только к сокращённому активному набору и к границе архива.
